...
var GrupoSaneas = (function(){
  ...
  function ponerCSS(){
    ...
    c.textContent = [
      ...
      '.gs-tit{font-size:13.5px;font-weight:700;color:#000;text-align:center;margin:0 0 12px}',
      ...
      '.gs-tx span{display:block;font-size:12.5px;color:#000;line-height:1.45;margin-top:3px}',
      ...
      '.gs-ficha p{font-size:15px;color:#000;line-height:1.6;margin:0 6px 18px}',
